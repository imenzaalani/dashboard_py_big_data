...
def plot_histogram():
    df_before = pd.read_csv("creditcard_before.csv") if os.path.exists("creditcard_before.csv") else pd.read_csv("creditcard.csv")
    df_after  = pd.read_csv("creditcard_after.csv")  if os.path.exists("creditcard_after.csv")  else pd.read_csv("creditcard.csv")
    fig = go.Figure()
...
def plot_box_before():
    df = pd.read_csv("creditcard_before.csv") if os.path.exists("creditcard_before.csv") else pd.read_csv("creditcard.csv")
...
def plot_box_after():
    df = pd.read_csv("creditcard_after.csv") if os.path.exists("creditcard_after.csv") else pd.read_csv("creditcard.csv")
